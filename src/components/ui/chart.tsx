        ...
        <div className="grid gap-1.5">
          {payload.map((item, _index) => {
            ...
            if (typeof item === 'object' && item !== null) {
              ...
              if (typeof itemObj.color === 'string') {
                itemColor = itemObj.color;
              }
            }
            ...
            return (
              ...
              >
                {formatter && item?.value !== undefined && item.name ? (
                  // Skip formatter for type safety - render default content instead
                  <>
                    {itemConfig?.icon ? (
                      <itemConfig.icon />
                    ) : (
    ...
    return (
      ...
      >
        {payload.map((item) => {
          ...
          return (
            <div
              key={item.value ? String(item.value) : key}
              className={cn(
