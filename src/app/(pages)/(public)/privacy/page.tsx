  ...
  return (
    <div className="container mx-auto flex flex-col gap-2 px-4 py-8">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to E-commerce Shop, 1234 Struga 6330.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            identified or identifiable inidual.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            <a
              href="https://abaz-exclusive.vercel.app/" // change this
              rel="external nofollow noopener"
              target="_blank"
            >
              {"https://abaz-exclusive.vercel.app/"}
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        close Your web browser. article.
      </p>
      <p>
      ...
      <p>
        ...
        You from within the Service. The most concrete way to delete everything
        about you is by deleting your user account from the User Dashboard.
      </p>
      <p>
      ...
      <ul>
        <li>
          <p>By using Conctact Form on this website.</p>
        </li>
      </ul>
    </div>
  );
